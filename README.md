...
Run `npm run test:karma` to execute the same spec suite via [Karma](https://karma-runner.github.io) instead. Nearly all specs run under both runners; a small, documented set are Karma-only.
