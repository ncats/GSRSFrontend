...
export const dynamicComponentManifests: LazyLoadedComponentManifest[] = [
  ...
  },
  {
    ...
    loadChildren: () => import('./substance-form/substance-form-subunits/substance-form-subunits.module').then(m => m.SubstanceFormSubunitsModule)
  },
  {
    componentId: 'substance-form-other-links',
    path: 'substance-form-other-links',
    loadChildren: () => import('./substance-form/substance-form-other-links/substance-form-other-links.module').then(m => m.SubstanceFormOtherLinksModule)
  },
  {
    componentId: 'substance-form-disulfide-links',
    path: 'substance-form-disulfide-links',
    loadChildren: () => import('./substance-form/substance-form-disulfide-links/substance-form-disulfide-links.module').then(m => m.SubstanceFormDisulfideLinksModule)
  },
  {
    componentId: 'substance-form-glycosylation',
    path: 'substance-form-glycosylation',
    loadChildren: () => import('./substance-form/substance-form-glycosylation/substance-form-glycosylation.module').then(m => m.SubstanceFormGlycosylationModule)
  },
  {
    componentId: 'substance-form-structural-modifications',
    path: 'substance-form-structural-modifications',
    loadChildren: () => import('./substance-form/substance-form-structural-modifications/substance-form-structural-modifications.module').then(m => m.SubstanceFormStructuralModificationsModule)
  },
  {
    componentId: 'substance-form-agent-modifications',
    path: 'substance-form-agent-modifications',
    loadChildren: () => import('./substance-form/substance-form-agent-modifications/substance-form-agent-modifications.module').then(m => m.SubstanceFormAgentModificationsModule)
  },
  {
    componentId: 'substance-form-physical-modifications',
    path: 'substance-form-physical-modifications',
    loadChildren: () => import('./substance-form/substance-form-physical-modifications/substance-form-physical-modifications.module').then(m => m.SubstanceFormPhysicalModificationsModule)
  },
  {
    componentId: 'substance-form-protein-details',
    path: 'substance-form-protein-details',
    loadChildren: () => import('./substance-form/substance-form-protein-details/substance-form-protein-details.module').then(m => m.SubstanceFormProteinDetailsModule)
  },
  {
    componentId: 'nucleic-acid-details-form',
    path: 'nucleic-acid-details-form',
    loadChildren: () => import('./substance-form/nucleic-acid-details-form/nucleic-acid-details-form.module').then(m => m.NucleicAcidDetailsFormModule)
  },
  {
    componentId: 'substance-form-links',
    path: 'substance-form-links',
    loadChildren: () => import('./substance-form/substance-form-links/substance-form-links.module').then(m => m.SubstanceFormLinksModule)
  },
  {
    componentId: 'substance-form-sugars',
    path: 'substance-form-sugars',
    loadChildren: () => import('./substance-form/substance-form-sugars/substance-form-sugars.module').then(m => m.SubstanceFormSugarsModule)
  },
  {
    componentId: 'substance-form-mixture-details',
    path: 'substance-form-mixture-details',
    loadChildren: () => import('./substance-form/substance-form-mixture-details/substance-form-mixture-details.module').then(m => m.SubstanceFormMixtureDetailsModule)
  },
  {
    componentId: 'substance-form-mixture-components',
    path: 'substance-form-mixture-components',
    loadChildren: () => import('./substance-form/substance-form-mixture-components/substance-form-mixture-components.module').then(m => m.SubstanceFormMixtureComponentsModule)
  },
  {
    componentId: 'substance-form-structurally-diverse-source',
    path: 'substance-form-structurally-diverse-source',
    loadChildren: () => import('./substance-form/substance-form-structurally-diverse-source/substance-form-structurally-diverse-source.module').then(m => m.SubstanceFormStructurallyDiverseSourceModule)
  },
  {
    componentId: 'substance-form-structurally-diverse-organism',
    path: 'substance-form-structurally-diverse-organism',
    loadChildren: () => import('./substance-form/substance-form-structurally-diverse-organism/substance-form-structurally-diverse-organism.module').then(m => m.SubstanceFormStructurallyDiverseOrganismModule)
  },
  {
    componentId: 'substance-form-constituents',
    path: 'substance-form-constituents',
    loadChildren: () => import('./substance-form/substance-form-constituents/substance-form-constituents.module').then(m => m.SubstanceFormConstituentsModule)
  },
  {
    componentId: 'substance-form-polymer-classification',
    path: 'substance-form-polymer-classification',
    loadChildren: () => import('./substance-form/substance-form-polymer-classification/substance-form-polymer-classification.module').then(m => m.SubstanceFormPolymerClassificationModule)
  },
  {
    componentId: 'substance-form-monomers',
    path: 'substance-form-monomers',
    loadChildren: () => import('./substance-form/substance-form-monomers/substance-form-monomers.module').then(m => m.SubstanceFormMonomersModule)
  },
  {
    componentId: 'substance-form-structural-units',
    path: 'substance-form-structural-units',
    loadChildren: () => import('./substance-form/substance-form-structural-units/substance-form-structural-units.module').then(m => m.SubstanceFormStructuralUnitsModule)
  }
];
