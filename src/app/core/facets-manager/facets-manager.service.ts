...
export class FacetsManagerService extends BaseHttpService {
  getFacetsHandler: (facet: Facet, searchTerm?: string, nextUrl?: string, otherFacets?: any) => Observable<FacetQueryResponse>;
  ...
  registerGetFacetsHandler(handler: (facet: Facet, searchTerm?: string, nextUrl?: string, otherFacets?: any) => Observable<FacetQueryResponse>): void {
