...
@Component({
    ...
    standalone: true,
    imports: [FormsModule, MatIconModule, MatButtonModule, MatTooltipModule, MatFormFieldModule, MatInputModule, CvInputComponent, SubstanceSelectorComponent]
})
export class Ssg4mResultingMaterialsFormComponent implements OnInit, OnDestroy {
  ...
  draftSubstanceSelected(event: any): void {
    ...
    // Populate the resulting material with draft data
    this.privateResultingMaterial.substanceName = {
    ...
    this.privateResultingMaterial.verbatimName = primaryName;
