...
} from "@gsrs-core/structure-editor";
...
@NgModule({
  ...
  declarations: [SubstanceSelectorComponent, AdvancedSelectorDialogComponent],
  exports: [SubstanceSelectorComponent, AdvancedSelectorDialogComponent],
})
