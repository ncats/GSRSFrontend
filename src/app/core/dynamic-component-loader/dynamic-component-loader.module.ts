...
export class DynamicComponentLoaderModule {
  static forRoot(
    ...
    ): ModuleWithProviders<DynamicComponentLoaderModule> {
    return {
  ...
  static forModule(manifest: LazyLoadedComponentManifest): ModuleWithProviders<DynamicComponentLoaderModule> {
    return {
      ngModule: DynamicComponentLoaderModule,
      providers: [
