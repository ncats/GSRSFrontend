...
describe('AdverseEventsCvmBrowseComponent', () => {
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      imports: [ AdverseEventsCvmBrowseComponent ],
      ...
      providers: [
        ...
        { provide: ConfigService, useValue: { configData: { facets: {} }, environment: {} } },
        ...
        // ngOnInit/ngOnDestroy call these directly; app-facets-manager (now genuinely instantiated
        // since it's standalone-imported) also subscribes to clearSelectionsEvent in its own ngOnInit.
        { provide: FacetsManagerService, useValue: { registerGetFacetsHandler: () => null, unregisterFacetSearchHandler: () => null, clearSelectionsEvent: new Subject() } },
