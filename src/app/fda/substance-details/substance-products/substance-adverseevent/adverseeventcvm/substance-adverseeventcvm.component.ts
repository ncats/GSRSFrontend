  ...
  implements OnInit
{
  ...
  ngOnInit() {
    const rolesSubscription = this.authService
      .hasAnyRolesAsync("Admin", "Updater", "SuperUpdater")
      .subscribe((response) => {
    ...
    if (sort.active) {
      ...
      this.sortValues.forEach((sortValue) => {
        if (sortValue.displayedColumns && sortValue.direction) {
          if (
            this.displayedColumns[orderIndex] === sortValue.displayedColumns &&
    ...
    if (this.etag) {
      ...
      if (this.authService.getUser() !== "") {
        const dialogReference = this.dialog.open(ExportDialogComponent, {
          ...
          data: {
            extension: extension,
            type: "substanceAdverseEventCvm",
            entity: "adverseeventcvm",
        ...
        dialogReference.afterClosed().subscribe((response) => {
          ...
          if (name && name !== "") {
            ...
            this.authService
              .startUserDownload(url, this.privateExport, fullname, id)
              .subscribe(
                (response) => {
